...
[Icons]
Name: "{group}\Wormhole (GUI)"; Filename: "wscript.exe"; Parameters: """{app}\wormhole\Wormhole-GUI.vbs"""; IconFilename: "{app}\wormhole\wormhole.exe"
...
Name: "{userdesktop}\Wormhole (GUI)"; Filename: "wscript.exe"; Parameters: """{app}\wormhole\Wormhole-GUI.vbs"""; IconFilename: "{app}\wormhole\wormhole.exe"
